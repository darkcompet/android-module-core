...
public class DkConfig {
	...
	public static int dp2px(float dp) {
		return Math.round(dp * densityDpi() / DisplayMetrics.DENSITY_DEFAULT);
	}

	public static int dp2px(float dp, float densityDpi) {
		return Math.round(dp * densityDpi / DisplayMetrics.DENSITY_DEFAULT);
	}

	public static int px2dp(float px) {
		return Math.round(px * DisplayMetrics.DENSITY_DEFAULT / densityDpi());
	}

	public static int px2dp(float px, float densityDpi) {
		return Math.round(px * DisplayMetrics.DENSITY_DEFAULT / densityDpi);
	}
	...
	public static int colorPrimaryDark(Context context) {
		return attrColor(context, androidx.appcompat.R.attr.colorPrimaryDark);
	}

	public static int colorPrimary(Context context) {
		return attrColor(context, androidx.appcompat.R.attr.colorPrimary);
	}

	public static int colorAccent(Context context) {
		return attrColor(context, androidx.appcompat.R.attr.colorAccent);
	}
