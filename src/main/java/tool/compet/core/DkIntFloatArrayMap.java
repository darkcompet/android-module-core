...
/**
 * This maps primitive `int` vs `float`.
 */
public class DkIntFloatArrayMap extends TheBaseSparseArray {
	...
	public DkIntFloatArrayMap(int capacity) {
		if (capacity <= 0) {
			this.keys = DkEmptyArray.INT;
			this.values = DkEmptyArray.FLOAT;
		}
		else {
