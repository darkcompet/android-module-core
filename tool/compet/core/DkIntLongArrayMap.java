...
/**
 * This maps primitive `int` vs `long`.
 */
public class DkIntLongArrayMap extends TheBaseSparseArray {
	private long[] values;
	...
	public DkIntLongArrayMap(int capacity) {
		if (capacity <= 0) {
			this.keys = DkEmptyArray.INT;
			this.values = DkEmptyArray.LONG;
		}
		else {
